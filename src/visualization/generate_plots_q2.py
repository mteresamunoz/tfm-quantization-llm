...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Generate grouped bar charts for LLM metrics comparison')
    parser.add_argument('--data_dir', type=str, required=True,
                        help='Directory containing metrics CSV files')
    parser.add_argument('--output_dir', type=str, default='./results/bar_plots',
...
def plot_grouped_bars(df, output_dir, model_palette):
    ...
    for metric in metrics:
        ...
        # Include LoRA ONLY for Mean accuracy
        ...
        try:
            ...
            print(f"Generated: bar_{safe_metric_name}.png")
...
def main():
    ...
    plot_grouped_bars(df, args.output_dir, model_palette)
